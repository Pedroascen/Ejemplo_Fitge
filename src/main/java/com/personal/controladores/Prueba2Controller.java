...
import com.personal.entidades.DetalleVenta;
import com.personal.entidades.Venta;
import com.personal.repositorios.IClienteRepository;
import com.personal.repositorios.IOrdenRepository;
...
class Prueba2Controller {
    ...
    public String pruebaMaestro() {
        ...
        l.add(new DetalleVenta(null, v, rProducto.findById(1).get(), 5));
        l.add(new DetalleVenta(null, v, rProducto.findById(2).get(), 3));
